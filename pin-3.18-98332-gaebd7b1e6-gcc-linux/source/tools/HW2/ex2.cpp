...
class BranchData {
   public:
    ...
    BranchData(ADDRINT routineAddr, string routineName, ADDRINT branchAddr, ADDRINT branchTrgt) : routineAddr(routineAddr), routineName(routineName), branchAddr(branchAddr), branchTrgt(branchTrgt), currNumIteration(0), lastNumIteration(0), totalIterNum(0), routineCounter(0), meanTaken(0), diffCounter(0), counterLoopInvoked(0){};
...
VOID Fini(INT32 code, VOID *v) {
    ...
    while (it1 != branchMap.end()) {
        ...
        it1->second.meanTaken = (it1->second.totalIterNum) / temp;
    ...
    fd_out << setw(23) << "target addrress"
           << ",";
    fd_out << setw(23) << "CountSeen"
           << ",";
    fd_out << setw(23) << "CountLoopInvoked"
           << ",";
    fd_out << setw(23) << "MeanTaken"
           << ",";
    fd_out << setw(23) << "DiffCount"
           << ",";
    fd_out << setw(23) << "routine name"
           << ",";
    fd_out << setw(23) << "routine address"
           << ",";
    fd_out << setw(23) << "routine invocations count" << endl;
    for (unsigned int i = 0; i < currVector.size(); ++i) {
        if (currVector[i].second.totalIterNum != 0) {
            BranchData currInfo = currVector[i].second;
            fd_out << setw(23) << hex << "0x" << currInfo.branchTrgt << dec << ",";
            fd_out << setw(23) << currInfo.totalIterNum << ",";
            fd_out << setw(23) << currInfo.counterLoopInvoked << ",";
            fd_out << setw(23) << currInfo.meanTaken << ",";
            fd_out << setw(23) << currInfo.diffCounter << ",";
            fd_out << setw(23) << currInfo.routineName << ",";
            fd_out << setw(23) << hex << currInfo.routineAddr << dec << ",";
            fd_out << setw(23) << currInfo.routineCounter << endl;
        }
    }
}
